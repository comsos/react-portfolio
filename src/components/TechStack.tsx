      ...
      <div className="flex flex-col justify-center items-center h-screen text-center mt-[-3rem] lg:text-3xl md:text-nav">
        <div className="flex flex-col mb-6">
          ...
          <div className="flex flex-row space-x-4 ">
            ...
            <img
              className="xl:h-14 lg:h-8 sm:h-8"
              src={tailwind}
              alt="tailwind"
            />
        ...
        <div className="flex flex-col mb-6">
          ...
          <div className="flex flex-row space-x-4 ">
            ...
            />
            <img
              className="xl:h-14 lg:h-8 sm:h-8 border-slate-800 bg-slate-800 rounded-lg"
              src={mysql}
              alt="mysql"
            />
            <img
        ...
        <div className="flex flex-col mb-6">
          ...
          <div className="flex flex-row space-x-4 ">
            ...
            <img
              className="xl:h-14 lg:h-8 sm:h-8 border border-slate-800 bg-slate-800 rounded-full"
              src={flask}
              alt="react"
            />
