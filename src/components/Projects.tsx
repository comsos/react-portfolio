...
export default function Projects({ mode }: ProjectsProps) {
  return (
    <Fade bottom distance="10%">
      <div>
        <div
          className={` container text-right right-0 mr-24 xl:text-nav text-2xl font-nue mt-48 absolute md:text-xl ${mode == "light" ? "text-black" : "text-white"}`}
        >
        ...
        <div className="flex flex-col justify-center items-center h-screen grid-cols-1 grid-rows-2">
          ...
          <div className="flex flex-row">
            ...
            <a
              ...
              target="_blank"
              className={`text-center font-nue text-nav ${mode == "light" ? "text-black" : "text-white"}`}
            >
              Renu Naturals
            </a>
          </div>
